...
def get_image_list(data_root, split):
	...
	with open('filelists/{}.txt'.format(split)) as f:
		for line in f:
			...
			filelist.append(data_root + line)
...
hparams = HParams(
	...
	nepochs=200000000000000000,  ### stop whenever eval loss is consistently greater than train loss for several epochs
	num_workers=16,
	...
	disc_wt=0.07,
	disc_initial_learning_rate=1e-3,
)
